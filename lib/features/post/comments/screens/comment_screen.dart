                                                        ...
                                                        data: (feeds) {
                                                          ...
                                                          return Padding(
                                                            padding: EdgeInsets.only(
                                                                right: 15,
                                                                bottom:
                                                                    feed.photoUrl.isEmpty ? 5 : 10,
                                                                top: feed.photoUrl.isEmpty
                                                                    ? 10
                                                                    : 15),
                                                            child: Row(
                                                              mainAxisAlignment:
