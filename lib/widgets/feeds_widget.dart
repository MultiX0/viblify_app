                              ...
                              child: GestureDetector(
                                onLongPress: () {
                                  if (post.isCommentsOpen != false) {
                                    ...
                                    Fluttertoast.showToast(msg: 'التعليقات مغلقة لهذا المنشور');
                                  }
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                      bottom: BorderSide(
                                        color: dividerColor.isEmpty ? Colors.grey.shade900 : HexColor(dividerColor),
                                      ),
                                    ),
                                  ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: () =>
                                            user.userID != myID ? navigationToUserScreen(user.userID, context) : null,
                                        child: CircleAvatar(
                                          radius: 20,
                                      ...
                                      Expanded(
                                        child: Column(
                                          children: [
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        if (user.verified) ...[
                                                          Icon(
                                                            Icons.verified,
                                                            color: isThemeDark ? Colors.blue : Colors.black,
                                                            size: 14,
                                                          ),
                                                          const SizedBox(
                                                            width: 5,
                                                          ...
                                                          child: GestureDetector(
                                                            ...
                                                            child: Text(
                                                              ...
                                                              style: TextStyle(
                                                                  fontWeight: FontWeight.bold,
                                                                  fontSize: 14,
                                                                  color: isThemeDark ? Colors.grey : Colors.grey[900]),
                                                            ),
                                                          ),
                                                        ),
                                                        Text(
                                                        ...
                                                        IconButton(
                                                          ...
                                                          icon: Icon(
                                                            Icons.more_vert,
                                                            size: 14,
                                                            color: isThemeDark ? Colors.grey : Colors.black,
                                                          ),
                                                        ),
                                                      ],
                                                    ),
                                            ...
                                            Padding(
                                              ...
                                              child: Align(
                                                ...
                                                child: Linkable(
                                                  ...
                                                  linkColor: isThemeDark ? Colors.blue : Colors.blue[900],
                                                  text: post.content,
                                                  style: TextStyle(fontWeight: isThemeDark ? null : FontWeight.bold),
                                                      ...
                                                      .map(
                                                        (item) => GestureDetector(
                                                          ...
                                                          child: Text(
                                                            "#$item",
                                                            style: TextStyle(
                                                                color: isThemeDark ? Colors.blue : Colors.blue[900],
                                                                fontSize: 14,
                                            ...
                                            if (post.gif.isNotEmpty) ...[
                                              GestureDetector(
                                                onDoubleTap: () => likeHunlidng(post.feedID),
                                                child: Padding(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    image: DecorationImage(
                                                        image: CachedNetworkImageProvider(
                                                          VideoURLValidator.getYouTubeThumbnail(post.youtubeVideoID),
                                                        ),
                                                        fit: BoxFit.cover),
                                                  ),
                                                  child: Align(
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: () => navigationToVideScreen(post.youtubeVideoID, context),
                                                      child: Container(
                                            ...
                                            ref.watch(getFeedByID(post.feedID)).when(
                                                  data: (feeds) {
                                                    ...
                                                    bool postLiked = feed.likes.contains(myID);
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Icon(
                                                                  LineIcons.share,
                                                                  color:
                                                                      isThemeDark ? Colors.grey.shade700 : Colors.black,
                                                                  size: 18.0,
                                                                ),
                                                                const SizedBox(width: 6.0),
                                                                Text(
                                                        ...
                                                        Row(
                                                          children: [
                                                            LikeButton(
                                                              size: 19,
                                                              onTap: (isLiked) =>
                                                                  onLikeButtonTapped(isLiked, post.feedID),
                                                              likeBuilder: (bool isLiked) {
                                                                return Icon(
                                                                  feedLiked ? Icons.favorite : Icons.favorite_border,
                                                                  color: feedLiked
                                                                      ? Colors.pinkAccent
                                                                      : Colors.grey.shade800,
                                                                  size: 19,
